...
class PlaylistTile extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _PlaylistTitleState();
}

class _PlaylistTitleState extends State<PlaylistTile> {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
        ...
        child: Container(
            ...
            child: Row(children: [
              Image.asset(widget.playlist.pictureFilePath, fit: BoxFit.contain),
              Expanded(
                  child: Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            Text(widget.playlist.title, style: boldTextStyle),
                            // const Spacer(),
